#############################################################################
# Makefile for building: mac_diagnostic.app/Contents/MacOS/mac_diagnostic
# Generated by qmake (3.1) (Qt 6.7.3)
# Project:  mac_diagnostic.pro
# Template: app
# Command: /opt/homebrew/opt/qt/bin/qmake -o Makefile mac_diagnostic.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = mac_diagnostic1.0.0
DISTDIR = /Users/leo/Documents/GitHub/check_mac/.tmp/mac_diagnostic1.0.0
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		diagnosticmanager.cpp moc_mainwindow.cpp \
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		mac_diagnostic.pro mainwindow.h \
		diagnosticmanager.h main.cpp \
		mainwindow.cpp \
		diagnosticmanager.cpp
QMAKE_TARGET  = mac_diagnostic
DESTDIR       = 
TARGET        = mac_diagnostic.app/Contents/MacOS/mac_diagnostic

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 14.5
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Applications/Xcode.app/Contents/Developer
EXPORT__QMAKE_STASH_ = /Users/leo/Documents/GitHub/check_mac/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/leo/Documents/GitHub/check_mac/mac_diagnostic.pro
...
mac_diagnostic.app/Contents/MacOS/mac_diagnostic:  $(OBJECTS)  
	@test -d mac_diagnostic.app/Contents/MacOS/ || mkdir -p mac_diagnostic.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: mac_diagnostic.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.7.3/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile mac_diagnostic.pro
...
mac_diagnostic.app/Contents/PkgInfo: 
	@test -d mac_diagnostic.app/Contents || mkdir -p mac_diagnostic.app/Contents
	@$(DEL_FILE) mac_diagnostic.app/Contents/PkgInfo
	@echo "APPL????" > mac_diagnostic.app/Contents/PkgInfo
mac_diagnostic.app/Contents/Info.plist: 
	@test -d mac_diagnostic.app/Contents || mkdir -p mac_diagnostic.app/Contents
	@$(DEL_FILE) mac_diagnostic.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,AHO.mac-diagnostic,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},AHO.mac-diagnostic,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,mac_diagnostic,g" -e "s,@LIBRARY@,mac_diagnostic,g" -e "s,\$${EXECUTABLE_NAME},mac_diagnostic,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >mac_diagnostic.app/Contents/Info.plist

all: Makefile \
		mac_diagnostic.app/Contents/PkgInfo \
		mac_diagnostic.app/Contents/Info.plist mac_diagnostic.app/Contents/MacOS/mac_diagnostic
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h diagnosticmanager.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp diagnosticmanager.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_diagnosticmanager.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_diagnosticmanager.cpp
...
moc_diagnosticmanager.cpp: diagnosticmanager.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/leo/Documents/GitHub/check_mac/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/leo/Documents/GitHub/check_mac -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include/c++/v1 -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/15.0.0/include -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX14.5.sdk/usr/include -I/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/include -F/opt/homebrew/lib diagnosticmanager.h -o moc_diagnosticmanager.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/mac_diagnostic/bin || mkdir -p $(INSTALL_ROOT)/opt/mac_diagnostic/bin
	$(DEL_FILE) -r $(INSTALL_ROOT)/opt/mac_diagnostic/bin/mac_diagnostic.app
	
	$(QINSTALL) mac_diagnostic.app $(INSTALL_ROOT)/opt/mac_diagnostic/bin/mac_diagnostic.app
	-$(STRIP) $(INSTALL_ROOT)/opt/mac_diagnostic/bin/mac_diagnostic.app/Contents/MacOS/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/mac_diagnostic/bin/mac_diagnostic.app
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/mac_diagnostic/bin/ 
